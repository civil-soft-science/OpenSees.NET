...
// $Source: /usr/local/cvs/OpenSees/SRC/handler/DataFileStreamAdd.h,v $

#ifndef _DataFileStreamAdd
#define _DataFileStreamAdd
...
class DataFileStreamAdd : public OPS_Stream
{
 public:
