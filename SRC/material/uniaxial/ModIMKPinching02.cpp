...
OPS_ModIMKPinching02(void)
{
  ...
  if (OPS_GetIntInput(numData, iData) != 0) {
	...
	if (theMaterial == 0) {
		opserr << "WARNING could not create uniaxialMaterial of type ModIMKPinching02 Material\n";
		return 0;
	}
...
:UniaxialMaterial(0,MAT_TAG_ModIMKPinching02),
...
{
  ModIMKPinching02 *theCopy = new ModIMKPinching02(this->getTag(), Ke0, AlfanPos, AlfanNeg, My_pos, My_neg, FprPos, FprNeg, A_pinch, Ls, Ld, La, Lk, 
...
void
ModIMKPinching02::envelPosCap2(double fy,double alphaPos,double alphaCap,double cpDsp,double& d,
...
void
ModIMKPinching02::envelNegCap2(double fy,double alphaNeg,double alphaCap,double cpDsp,double& d,
