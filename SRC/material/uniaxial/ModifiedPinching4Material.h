...
// $Source: /usr/local/cvs/OpenSees/SRC/material/uniaxial/ModifiedPinching4Material.h,v $
...
#ifndef ModifiedPinching4Material_h
#define ModifiedPinching4Material_h
...
class ModifiedPinching4Material : public UniaxialMaterial
{
public :
	ModifiedPinching4Material(int tag,
