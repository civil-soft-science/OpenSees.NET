...
// edited by Giovanni Rinaldin for thermal version
...
static int numShellNLDKGTThermal = 0;

void *
OPS_ShellNLDKGTThermal(void)          
{
  if (numShellNLDKGTThermal == 0) {
//    opserr << "Using ShellNLDKGTThermal - Developed by:Shuhao Zhang & Xinzheng Lu";
    numShellNLDKGTThermal++;
  }
  ...
  if (numArgs < 5) {
    opserr << "Want: element ShellNLDKGTThermal $tag $iNode $jNoe $kNode $secTag";   
    return 0;	
  }
  ...
  if (OPS_GetInt(&numData, iData) != 0) {
    opserr << "WARNING invalid integer tag: element ShellNLDKGTThermal \n";
    return 0;
  }
  ...
  if (theSection == 0) {
    opserr << "ERROR:  element ShellNLDKGTThermal " << iData[0] << "section " << iData[4] << " not found\n";
    return 0;
  }
  
  theElement = new ShellNLDKGTThermal(iData[0], iData[1], iData[2], iData[3],
...
void *
OPS_ShellNLDKGTThermal(const ID& info)
{

    if (info.Size() == 0) {
	opserr << "WARNING: info is empty -- ShellNLDKGTThermal\n";
	return 0;
    }
	...
	if (OPS_GetIntInput(&numData, &secTag) < 0) {
	    opserr << "WARNING: failed to get section tag -- ShellNLDKGTThermal\n";
	    return 0;
	}
	...
	if (theSection == 0) {
	    opserr << "ERROR:  element ShellNLDKGTThermal " << info(2) << "section " << secTag << " not found\n";
	    return 0;
	}
	...
	return new ShellNLDKGTThermal(info(2), info(3), info(4), info(5),
			       *theSection);
    }
...
//static data
Matrix  ShellNLDKGTThermal::stiff(18,18) ;                    
Vector  ShellNLDKGTThermal::resid(18) ;
Matrix  ShellNLDKGTThermal::mass(18,18) ;

//some data

const double  ShellNLDKGTThermal::one_over_three =1.0/3.0 ;
const double  ShellNLDKGTThermal::one_over_five = 1.0/5.0;
const double ShellNLDKGTThermal:: three_over_five= 3.0/5.0  ;
const double ShellNLDKGTThermal:: wg1= -9.0/16.0;
const double ShellNLDKGTThermal:: wg2= 25.0/48.0;

// integration point
double ShellNLDKGTThermal::sg[4] ;
double ShellNLDKGTThermal::tg[4] ;
double ShellNLDKGTThermal::qg[4] ;
double ShellNLDKGTThermal::wg[4] ;

 

//null constructor
ShellNLDKGTThermal::ShellNLDKGTThermal( ) :                              
Element( 0, ELE_TAG_ShellNLDKGTThermal ),
...
//*********************************************************************
//full constructor
ShellNLDKGTThermal::ShellNLDKGTThermal(  int tag,                       
                         int node1,
                         int node2,
   	                     int node3,
	                     SectionForceDeformation &theMaterial,
                       Damping *damping) :
Element( tag, ELE_TAG_ShellNLDKGTThermal ),
connectedExternalNodes(3), CstrainGauss(32),TstrainGauss(32),load(0), Ki(0)
{
  int i;
  ...
  for ( i = 0 ;  i < 4; i++ ) {
      ...
      if (materialPointers[i] == 0) {
	      opserr << "ShellNLDKGTThermal::constructor - failed to get a material of type: ShellSection\n";
      } //end if
  ...
  if (damping)
  {
    for (i = 0; i < 4; i++)
    {
      ...
      if (!theDamping[i]) {
        opserr << "ShellNLDKGTThermal::ShellNLDKGTThermal -- failed to get copy of damping\n";
      }
    }
  }
  else
...
//**************************************************************************
//set domain
void  ShellNLDKGTThermal::setDomain( Domain *theDomain )                             
{  
  int i;
  ...
  for ( i = 0; i < 3; i++ ) {
     ...
     if (nodePointers[i] == 0) {
       opserr << "ShellNLDKGTThermal::setDomain - no node " << connectedExternalNodes(i);
       opserr << " exists in the model\n";
     }
      const Vector &nodeDisp=nodePointers[i]->getTrialDisp();
     if (nodeDisp.Size() != 6) {
       opserr << "ShellNLDKGTThermal::setDomain - node " << connectedExternalNodes(i);
 ...
 updateBasis( ) ;                                    
  ...
  for (i = 0; i < 4; i++)
  {
    if (theDamping[i] && theDamping[i]->setDomain(theDomain, 8)) {
      opserr << "ShellNLDKGTThermal::setDomain -- Error initializing damping\n";
      exit(-1);
    }
  }
...
int
ShellNLDKGTThermal::setDamping(Domain *theDomain, Damping *damping)
{
  if (theDomain && damping)
  {
    for (int i = 0; i < 4; i++)
    {
      ...
      if (!theDamping[i]) {
        opserr << "ShellNLDKGTThermal::setDamping -- failed to get copy of damping\n";
        return -1;
      }
      if (theDamping[i]->setDomain(theDomain, 8)) {
        opserr << "ShellNLDKGTThermal::setDamping -- Error initializing damping\n";
        return -2;
      }
    }
  }
...
int  ShellNLDKGTThermal::getNumExternalNodes( ) const
{
  return 3 ;
} 
...
const ID&  ShellNLDKGTThermal::getExternalNodes( ) 
{
...
Node **
ShellNLDKGTThermal::getNodePtrs(void) 
{
  return nodePointers;
} 

//return number of dofs
int  ShellNLDKGTThermal::getNumDOF( ) 
{
  return 18 ;
}
...
//commit state
int  ShellNLDKGTThermal::commitState( )
{
  int success = 0 ;

  // call element commitState to do any base class stuff
  if ((success = this->Element::commitState()) != 0) {
    opserr << "ShellNLDKGTThermal::commitState () - failed in base class";
  }    
...
int  ShellNLDKGTThermal::revertToLastCommit( ) 
{
  int i ;
  int success = 0 ;
...
//revert to start 
int  ShellNLDKGTThermal::revertToStart( ) 
{
  int i ;
  int success = 0 ;
...
void  ShellNLDKGTThermal::Print( OPS_Stream &s, int flag )
{
    if (flag == -1) {
        int eleTag = this->getTag();
        s << "EL_ShellNLDKGTThermal\t" << eleTag << "\t";
        s << eleTag << "\t" << 1;
...
Response*
ShellNLDKGTThermal::setResponse(const char **argv, int argc, OPS_Stream &output)
{
  Response *theResponse = 0;

  output.tag("ElementOutput");
  output.attr("eleType", "ShellNLDKGTThermal");
  ...
  if (strcmp(argv[0],"force") == 0 || strcmp(argv[0],"forces") == 0 ||
    ...
    if (argc < 2) {
      opserr << "ShellNLDKGTThermal::setResponse() - need to specify more data\n";
      return 0;
    }
...
int
ShellNLDKGTThermal::getResponse(int responseID, Information &eleInfo)
{
  int cnt = 0;
...
int
ShellNLDKGTThermal::setParameter(const char **argv, int argc, Parameter &param)
{
  int res = -1;
...
const Matrix&  ShellNLDKGTThermal::getTangentStiff( ) 
{
...
const Matrix&  ShellNLDKGTThermal::getInitialStiff( ) 
{
	if(Ki!=0)
		return *Ki;
...
//return mass matrix
const Matrix&  ShellNLDKGTThermal::getMass( ) 
{
  int tangFlag = 1 ;
...
void  ShellNLDKGTThermal::zeroLoad( )
{
  if (load != 0)
    load->Zero();
  return ;
...
int 
ShellNLDKGTThermal::addLoad(ElementalLoad *theLoad, double loadFactor)
{
	int type;
		...
		for (int j = 0; j < 4; j++) {
			...
			for (int i = 0; i < 3; i++) {
				theIntCrds(i) = shapefn2d(xi, eta, 1) * theNode1Crds(i) + shapefn2d(xi, eta, 2) * theNode2Crds(i) +
					shapefn2d(xi, eta, 3) * theNode3Crds(i);
			}
	...
	//end of thermalActionWrapper
		...
		opserr << "ShellNLDKGTThermal::addLoad - load type unknown for ele with tag: " << this->getTag() << endln;
		return -1;
	}
	return 0;
}
...
int 
ShellNLDKGTThermal::addInertiaLoadToUnbalance(const Vector &accel)
{
  int tangFlag = 1 ;
  static Vector r(18);
...
//get residual
const Vector&  ShellNLDKGTThermal::getResistingForce( ) 
{
...
const Vector&  ShellNLDKGTThermal::getResistingForceIncInertia( )
{
...
void   
ShellNLDKGTThermal::formInertiaTerms( int tangFlag ) 
...
void  
ShellNLDKGTThermal::formResidAndTangent( int tang_flag ) 
{
	//
   ...
   //transpose TmatTran=transpose(Tmat)
	...
	dstrain.Zero( );
		...
		const Vector &ul = nodePointers[j]->getTrialDisp( );
			...
			//Added by Liming, 2015 for unconverged loop - GR
	...
	dstrain_nl.Zero( );//add for accelerate the convergence,but not zero in stability analysis problems.
		...
		Vector newStrain = Vector(nstress);
		newStrain.Zero();
		for (int mi = 0; mi < nstress; mi++)
...
void   
ShellNLDKGTThermal::computeBasis( ) 
{  
...
void   
ShellNLDKGTThermal::updateBasis( ) 
{
...
const Matrix&  
ShellNLDKGTThermal::assembleB( const Matrix &Bmembrane,
                               const Matrix &Bbend, 
                               const Matrix &Bshear ) 
{
	static Matrix B(8,6);
...
const Matrix&
ShellNLDKGTThermal::computeBmembrane(int node, const double shp[3][3],
...
const Matrix&
 ShellNLDKGTThermal::computeBbend(int node ,const double shpBend[6][9])
 {
...
//compute BG matrix
const Matrix&
 ShellNLDKGTThermal::computeBG(int node ,const double shpBend[6][9])
 {
...
// added GR
double
ShellNLDKGTThermal::shapefn2d(double ss, double tt, int i)

{
	...
	switch (i) {
	case 1:
		shpVal = 1/3 * (1 - ss) * (1 - tt); break;
	case 2:
		shpVal = 1 / 3 * (1 + ss) * (1 - tt); break;
	case 3:
		shpVal = 1 / 3 * (1 + ss) * (1 + tt); break;
	default:
		opserr << "ShellNLDKGTThermal::shapefn2d received an invalid i: " << i << endln;
	}
	return shpVal;
}
...
const Vector&
 ShellNLDKGTThermal::computeNLdstrain(const Matrix &BG,const Vector &dispIncLocalBend)
{
...
void  
ShellNLDKGTThermal::shape2d( double ss, double tt,double qq, 
		           const double x[2][3], 
		           double shp[3][3],
...
void
ShellNLDKGTThermal::shapeDrill(double ss, double tt,double qq, 
					  const double x[2][3],
...
void 
	ShellNLDKGTThermal::shapeBend(double ss, double tt, double qq, const double x[2][3],
...
int  ShellNLDKGTThermal::sendSelf (int commitTag, Channel &theChannel)
{
  int res = 0;
  ...
  if (res < 0) {
    opserr << "WARNING ShellNLDKGTThermal::sendSelf() - " << this->getTag() << " failed to send ID\n";
    return res;
  }
  ...
  if (res < 0) {
    opserr << "WARNING ShellNLDKGTThermal::sendSelf() - " << this->getTag() << " failed to send committed strains\n";
    return res;
  }  
  ...
  for (i = 0; i < 4; i++) {
    ...
    if (res < 0) {
      opserr << "WARNING ShellNLDKGTThermal::sendSelf() - " << this->getTag() << " failed to send its Material\n";
      return res;
    }
  }
  ...
  if (theDamping[0]) {
    for (int i = 0 ;  i < 4; i++) {
      ...
      if (res < 0) {
        opserr << "ShellNLDKGTThermal::sendSelf -- could not send Damping\n";
        return res;
      }
    }
  }
...
int  ShellNLDKGTThermal::recvSelf (int commitTag, 
		       Channel &theChannel, 
		       FEM_ObjectBroker &theBroker)
{
  ...
  if (res < 0) {
    opserr << "WARNING ShellNLDKGTThermal::recvSelf() - " << this->getTag() << " failed to receive ID\n";
    return res;
  }
  ...
  if (materialPointers[0] == 0) {
    for (i = 0; i < 4; i++) {
      ...
      if (materialPointers[i] == 0) {
	opserr << "ShellNLDKGTThermal::recvSelf() - Broker could not create NDMaterial of class type" << matClassTag << endln;;
	return -1;
      }
      ...
      if (res < 0) {
	opserr << "ShellNLDKGTThermal::recvSelf() - material " << i << "failed to recv itself\n";
	return res;
      }
    }
  }
  ...
  if (dmpTag) {
    for (i = 0 ;  i < 4; i++) {
      ...
      if (theDamping[i] == 0) {
        ...
        if (theDamping[i] == 0) {
          opserr << "ShellNLDKGTThermal::recvSelf -- could not get a Damping\n";
          exit(-1);
        }
      }
      ...
      if (res < 0) {
        opserr << "ShellNLDKGTThermal::recvSelf -- could not receive Damping\n";
        return res;
      }
    }
  }
...
int
ShellNLDKGTThermal::displaySelf(Renderer &theViewer, int displayMode, float fact)
{
